# AQI-Checker - Simple Reflex Agent
*Code and test file for an AQI Checker implemented as a Simple Reflex Agent. Open to scalability.*  
...
## Features 
- Reads environmental sensor values from a `.txt` file  
- Simulates a **Simple Reflex Agent**  
- Calculates the **Air Quality Index (AQI)**  
- Displays AQI category and health recommendations  
- Shows formatted sensor readings  
...
- The AQI category
- The AQI scale position
- Recommended actions based on the air quality level
